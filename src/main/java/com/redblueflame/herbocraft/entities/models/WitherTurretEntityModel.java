...
public class WitherTurretEntityModel extends EntityModel<WitherTurretEntity> {
    ...
    public WitherTurretEntityModel() {
        textureWidth = 64;
        textureHeight = 64;
        ...
        cristal.setPivot(-5.25F, -1.25F, 4.0F);
        corne.addChild(cristal);
        setRotationAngle(cristal, 1.309F, -2.0071F, 1.4835F);
        ...
        cristal9.setPivot(-7.0F, 1.25F, -4.0001F);
        corne.addChild(cristal9);
        setRotationAngle(cristal9, -1.8326F, 1.1345F, -2.0944F);
        cristal9.setTextureOffset(26, 32).addCuboid(-10.517F, -1.8706F, -1.0001F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        cristal9.setTextureOffset(18, 18).addCuboid(-11.517F, -1.3706F, -0.5001F, 1.0F, 1.0F, 1.0F, 0.0F, false);

        cristal8 = new ModelPart(this);
        cristal8.setPivot(-4.5F, 3.75F, 0.0F);
        corne.addChild(cristal8);
        setRotationAngle(cristal8, 0.0F, 0.0F, 1.1345F);
        ...
        cristal6.setPivot(-5.25F, 0.0F, 4.5F);
        corne.addChild(cristal6);
        setRotationAngle(cristal6, 0.0F, -1.309F, 0.0F);
        cristal6.setTextureOffset(34, 34).addCuboid(-10.6938F, -2.0F, -1.1768F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        cristal6.setTextureOffset(20, 23).addCuboid(-11.6938F, -1.5F, -0.6769F, 1.0F, 1.0F, 1.0F, 0.0F, false);

        cristal7 = new ModelPart(this);
        cristal7.setPivot(-4.0F, -1.0F, -4.5F);
        corne.addChild(cristal7);
        setRotationAngle(cristal7, 1.5708F, 1.309F, 0.0F);
        cristal7.setTextureOffset(0, 34).addCuboid(-11.0F, -2.0F, -0.7501F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        cristal7.setTextureOffset(0, 23).addCuboid(-12.0F, -1.5F, -0.2501F, 1.0F, 1.0F, 1.0F, 0.0F, false);

        cristal5 = new ModelPart(this);
        cristal5.setPivot(-4.75F, 2.5F, -4.25F);
        corne.addChild(cristal5);
        setRotationAngle(cristal5, 0.0F, 1.3963F, -0.1745F);
        ...
        cristal4.setPivot(-2.5F, 2.25F, -0.25F);
        corne.addChild(cristal4);
        setRotationAngle(cristal4, 0.0F, 0.4363F, 0.7854F);
        ...
        cristal3.setPivot(-2.5F, 2.25F, 0.5F);
        corne.addChild(cristal3);
        setRotationAngle(cristal3, 0.0F, -0.4363F, 0.7854F);
        ...
        cristal2.setPivot(-4.75F, 2.5F, 4.25F);
        corne.addChild(cristal2);
        setRotationAngle(cristal2, 0.0F, -1.3963F, -0.1745F);
    ...
    @Override
    public void setAngles(WitherTurretEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
